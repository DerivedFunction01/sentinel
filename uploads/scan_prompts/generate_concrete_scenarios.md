...
- RETAIL/HOSPITALITY: Invent specific promo codes (e.g., "SUMMER30"), reward tiers ("Platinum Elite"), menu items, or reservation times. For disputes and refunds, invent concrete transactional points of friction, such as specific missing items from an order, exact double-charge dollar amounts, delivery delays, or unfulfilled service expectations (e.g., "I ordered the $45 dry-aged ribeye medium-rare at 7:30 PM but it came out completely cold and charred, I want a supervisor to reverse the charge on my card ending in 8812").
...
- MEDICAL/HOSPITAL: Invent specific medication names (e.g., Lisinopril, Metformin), exact dosages (e.g., "10mg twice daily"), specific symptoms, past social behavior or medical intakes ("e.g. I smoked 3 packs a week"), or department names (e.g., Oncology triage).
